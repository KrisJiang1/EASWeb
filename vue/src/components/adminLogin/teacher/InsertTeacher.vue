  ...
  <div class = "insertStudent">
    <el-form :model="teacher" :rules="rules" ref="teacher" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="联系方式" prop="teacherPhone">
        <el-input v-model="teacher.teacherPhone"></el-input>
      </el-form-item>

      <el-form-item label="身份证件" prop="teacherIdNum">
        <el-input v-model="teacher.teacherIdNum"></el-input>
      </el-form-item>

      <el-form-item label="所属专业" prop="teacherMajor">
        <el-select v-model="teacher.teacherMajor.majorId" placeholder="请选择">
          <el-option
      ...
      <el-form-item>
        <el-button type="primary" @click="submitForm('teacher')">立即添加</el-button>
